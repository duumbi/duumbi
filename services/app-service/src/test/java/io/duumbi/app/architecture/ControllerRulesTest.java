...
import static io.duumbi.app.architecture.ArchitectureConstants.ANNOTATED_EXPLANATION;
import static io.duumbi.app.architecture.ArchitectureConstants.CONTROLLER_PACKAGE;
import static io.duumbi.app.architecture.ArchitectureConstants.CONTROLLER_SUFFIX;
import static io.duumbi.app.architecture.CommonRules.beanMethodsAreNotAllowedRule;
import static io.duumbi.app.architecture.CommonRules.componentAnnotationIsNotAllowedRule;
import static io.duumbi.app.architecture.CommonRules.fieldsShouldNotBePublic;
import static io.duumbi.app.architecture.CommonRules.privateMethodsAreNotAllowedRule;
import static io.duumbi.app.architecture.CommonRules.publicConstructorsRule;
import static io.duumbi.app.architecture.CommonRules.staticMethodsAreNotAllowedRule;
